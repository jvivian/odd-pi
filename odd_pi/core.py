...
# %% auto 0
__all__ = ['FILE_PATH', 'DATA_DIR', 'NAME_PATH', 'TEST_PATH', 'CMD', 'TOKEN', 'intents', 'client', 'pltimg', 'capture_and_fetch',
           'predict', 'get_default_model', 'on_ready', 'on_member_join', 'on_message', 'take_picture']
